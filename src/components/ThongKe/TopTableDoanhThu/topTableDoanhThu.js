...
export default class TopTableDoanhThu extends Component {
  constructor(props) {
    super(props)
    this.state = {
      items: [],
  ...
  componentDidMount() {
    AuthService.top10SanPhamCoDoanhThuCaoNhat().then(
      res => {
  ...
  render() {
    ...
    return (
      <div>
        <Title title="Danh Sách Sản Phẩm Có Doanh Thu Cao Nhất" />
